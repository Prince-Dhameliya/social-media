...
export default function FollowingModel({open, setOpen, persons, currentUser}) {
      ...
      >
        <div className="FollowingModel">
            <div className="FollowingModelTitleSection">
                <span className='FollowingModelTitle'>Following</span>
            ...
            {persons.map((person, id)=>{
                if(currentUser?.following?.includes(person._id)){
